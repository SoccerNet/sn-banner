...
# Template for custom transform, but not used.
# See https://github.com/open-mmlab/mmengine/blob/main/docs/en/advanced_tutorials/data_transform.md
# See https://github.com/open-mmlab/mmsegmentation/blob/main/docs/en/advanced_guides/transforms.md
# Custom transform derived from RandomCrop, implementation in https://github.com/open-mmlab/mmsegmentation/blob/main/mmseg/datasets/transforms/transforms.py
