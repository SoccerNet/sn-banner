_base_ = ["../default_runtime.py", "./challenge_soccernet.py"]
...
default_hooks = dict(
    ...
    logger=dict(type="LoggerHook", interval=135, log_metric_by_epoch=False),
...
#       or not by default.
#   - `base_batch_size` = (N GPUs) x (2 samples per GPU).
