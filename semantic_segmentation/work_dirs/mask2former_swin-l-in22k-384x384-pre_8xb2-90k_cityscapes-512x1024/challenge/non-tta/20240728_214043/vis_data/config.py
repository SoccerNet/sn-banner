...
iters = 40000
launcher = 'none'
load_from = 'work_dirs/mask2former_swin-l-in22k-384x384-pre_8xb2-90k_cityscapes-512x1024/20240725_222653/best_mIoU_iter_10935.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir='inferences/mask2former/challenge/non-tta',
    type='IoUMetric')
