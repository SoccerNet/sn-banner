...
iters = 40000
launcher = 'none'
load_from = 'work_dirs/pointrend_r101_4xb2-80k_cityscapes-512x1024/best_mIoU_iter_9450.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir='inferences/pointrend/tta',
    type='IoUMetric')
...
work_dir = './work_dirs/config/test'
