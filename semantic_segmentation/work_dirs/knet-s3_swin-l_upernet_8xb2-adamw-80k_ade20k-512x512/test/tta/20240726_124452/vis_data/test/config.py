...
iters = 40000
launcher = 'none'
load_from = 'work_dirs/knet-s3_swin-l_upernet_8xb2-adamw-80k_ade20k-512x512/best_mIoU_iter_19710.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir='inferences/knet/tta',
    type='IoUMetric')
...
work_dir = './work_dirs/work_dirs/knet-s3_swin-l_upernet_8xb2-adamw-80k_ade20k-512x512/20240726_124452/vis_data/test'
