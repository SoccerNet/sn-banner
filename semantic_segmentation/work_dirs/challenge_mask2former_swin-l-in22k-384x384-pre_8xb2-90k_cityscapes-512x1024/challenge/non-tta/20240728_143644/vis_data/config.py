...
iters = 10935
launcher = 'none'
load_from = 'work_dirs/challenge_mask2former_swin-l-in22k-384x384-pre_8xb2-90k_cityscapes-512x1024/20240728_100106/best_mIoU_iter_10935.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir='inferences/challenge_mask2former/non-tta',
    type='IoUMetric')
train_cfg = dict(
...
work_dir = './work_dirs/mask2former_swin-l-in22k-384x384-pre_8xb2-90k_cityscapes-512x1024/challenge/non-tta'
