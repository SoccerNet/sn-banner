...
iters = 80000
launcher = 'slurm'
load_from = 'work_dir/split_models/mask2former/mask2former_swin-l-in22k-384x384-pre_8xb2-90k_cityscapes-512x1024.py/best_mIoU_iter_17400.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir=
    'out_models/mask2former/mask2former_swin-l-in22k-384x384-pre_8xb2-90k_cityscapes-512x1024.py/non-tta',
    type='IoUMetric')
...
work_dir = 'work_dir/teval2_models/mask2former/mask2former_swin-l-in22k-384x384-pre_8xb2-90k_cityscapes-512x1024.py/test'
