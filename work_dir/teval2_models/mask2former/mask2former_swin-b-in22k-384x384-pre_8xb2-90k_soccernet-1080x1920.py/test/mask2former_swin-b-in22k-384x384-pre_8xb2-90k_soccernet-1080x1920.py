...
iters = 80000
launcher = 'slurm'
load_from = 'work_dir/split_models/mask2former/mask2former_swin-b-in22k-384x384-pre_8xb2-90k_soccernet-1080x1920.py/best_mIoU_iter_23100.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir=
    'out_models/mask2former/mask2former_swin-b-in22k-384x384-pre_8xb2-90k_soccernet-1080x1920.py/non-tta',
    type='IoUMetric')
train_cfg = dict(max_iters=80000, type='IterBasedTrainLoop', val_interval=300)
...
work_dir = 'work_dir/teval2_models/mask2former/mask2former_swin-b-in22k-384x384-pre_8xb2-90k_soccernet-1080x1920.py/test'
