...
data_root = '/scratch/users/vgaspar/banner-replacement/semantic_segmentation/../work_dir'
...
iters = 10935
launcher = 'none'
load_from = '/scratch/users/vgaspar/banner-replacement/semantic_segmentation/models/challenge_mask2former/best_mIoU_iter_10935.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/scratch/users/vgaspar/banner-replacement/semantic_segmentation/../work_dir/ann_file.txt',
        data_prefix=dict(img_path='images', seg_map_path='images'),
        data_root=
        '/scratch/users/vgaspar/banner-replacement/semantic_segmentation/../work_dir',
        pipeline=[
...
test_evaluator = dict(
    ...
    output_dir=
    '/scratch/users/vgaspar/banner-replacement/semantic_segmentation/../work_dir/masks',
    type='IoUMetric')
train_cfg = dict(
...
work_dir = '/scratch/users/vgaspar/banner-replacement/semantic_segmentation/../work_dir/logs/'
