...
default_hooks = dict(
    checkpoint=dict(
        ...
        save_best='mIoU',
        type='CheckpointHook'),
    logger=dict(interval=75, log_metric_by_epoch=False, type='LoggerHook'),
...
work_dir = 'work_dir/split_models/segformer/segformer_mit-b4_8xb1-160k_cityscapes-1024x1024.py'
