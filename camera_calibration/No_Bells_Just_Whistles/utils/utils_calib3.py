...
class FramebyFrameCalib:
    ...
    def get_cam_params(self, mode="full", use_ransac=0, refine=False):
        ...
        if len(obj_pts) < 6:
            ...
            mtxInit = cv2.initCameraMatrix2D(
                self.obj_pts,
                self.img_pts,
                (self.image_width, self.image_height),
                aspectRatio=1.0,
            ...
            if ret > 10.0:
                ...
                if ret2 < ret:
                    ret, mtx, dist, rvecs, tvecs = ret2, mtx2, dist2, rvecs2, tvecs2
    ...
    def get_homography_from_ground_plane(self, use_ransac=5.0, inverse=False):
    ...
    def get_homography_from_3D_projection(self, use_ransac=5.0, inverse=False):
