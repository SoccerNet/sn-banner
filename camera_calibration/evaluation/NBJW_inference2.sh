...
# Description:
#
#   -   This script is used to evaluate the original camera calibration model
#       No Bells Just Whistles (NBJW) on the SoccerNet Game State (sn-gamestate)
#       dataset.
...
SAVE_DIR="inferences2_3_1080_1920_2.4.0/"
